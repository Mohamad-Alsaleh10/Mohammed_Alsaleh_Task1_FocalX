...
const InfoTable = () => {
  return (
    <div className="info-table">
      <ul>
        <li>
          <img src={infoIcon1} alt="" style={{ maxWidth: 52 }} />
          <h4>
            250 m2
            <br />
        ...
        <li>
          <img src={infoIcon2} alt="" style={{ maxWidth: 52 }} />
          <h4>
            Contract
            <br />
        ...
        <li>
          <img src={infoIcon3} alt="" style={{ maxWidth: 52 }} />
          <h4>
            Payment
            <br />
        ...
        <li>
          <img src={infoIcon4} alt="" style={{ maxWidth: 52 }} />
          <h4>
            Safety
            <br />
